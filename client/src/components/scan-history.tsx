...
function getIndustryColor(industry: string): string {
  const colors: Record<string, string> = {
    ...
    "Baking & Milling": "bg-amber-500/10 text-amber-700 dark:text-amber-400",
    "IPPE Exhibitors": "bg-violet-500/10 text-violet-700 dark:text-violet-400",
    "Feed & Grain": "bg-teal-500/10 text-teal-700 dark:text-teal-400",
